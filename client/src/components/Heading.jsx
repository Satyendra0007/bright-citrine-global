export default function Heading({ subhead, head }) {
  return (
    <div className="flex items-center gap-2 px-2 my-2">
      ...
      <div className="heading">
        ...
        <h1 className="text-xl md:text-2xl font-bold -mt-0.5"><span className="text-gray-600 font-semibold"> OUR </span>{head}</h1>
      </div>
    </div>
  )
}
